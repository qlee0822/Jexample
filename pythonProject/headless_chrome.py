...
for movie in movies:
    ...
    #할인 전 가격
    original_price = movie.find("span", attrs={"JC7Ub"})["href"]
    if original_price:
    ...
    #할인 된 가격
    price = movie.find("span", attrs={"class":"VfPpfd ZdBevf i50DZme"}).get_text()

    #링크
    link = movie.find("a", attrs={"class":"VfPpfd ZdBevf i50DZme"})

    #올바른 링크 : https://play.goolge.com + link
